...
def main():
    try:
        ...
        st.title(f"🧙🔮🤖 Elysium Task Wizard ✨🪄 made for Elysium Innovations for {DEFAULT_INVESTOR}")
        st.markdown(
            """
        ...
        if openai_api_key:
            ...
            OBJECTIVE = st.text_input(
                ...
                value="Create an ML algorithm to lower business default rates by 15% in 6 months.",
            )
            ...
            first_task = st.text_input(
                ...
                value="Gather past transaction data and engage a team to develop a credit risk model.",
            )
